...
class ARADFoil_Old(Foil):
    ...
    def __repr__(self):
        hsh = self.hash()
        return "ARAD ch={:5.1f}mm, thickness={:4.2f}%  depth={:4.2}mm te={:4.3f} hsh={}".format(
            self.chord * 1000,
            self.thickness * 100,
            (self.chord * self.thickness) * 1000,
            self.trailing_edge,
            hsh,
        )
...
class ARADFoil(Foil):
    ...
    def __repr__(self):
        hsh = self.hash()
        return "ARAD_I ch={:5.1f}mm, thickness={:4.2f}%  depth={:4.2}mm te={:4.3f} hsh={}".format(
            self.chord * 1000,
            self.thickness * 100,
            (self.chord * self.thickness) * 1000,
            self.trailing_edge,
