...
fn naca0012_coords() -> (Vec<f64>, Vec<f64>) {
    let x = [
        1.0000e+00, 9.9168e-01, 9.8037e-01, 9.6727e-01, 9.5272e-01, 9.3720e-01, 9.2112e-01, 9.0474e-01,
...
fn test_aseq() {
    ...
    let ref_cl = [
        ...
        1.3808, 1.3900, 1.3877, 1.3670, 1.3323, 1.3041, 1.2680, 1.2288, 1.1901, 1.1541,
    ];
    let ref_cd = [
        ...
        0.0317, 0.0357, 0.0417, 0.0509, 0.0628, 0.0745, 0.0879, 0.1023, 0.1171, 0.1321,
    ];
    ...
    for (i, r) in res.iter().enumerate() {
        close(r.0, -20.0 + 0.5 * i as f64, 1.0e-4, &format!("alpha[{}]", i));
...
fn test_cseq() {
    ...
    let ref_cd = [
        ...
        0.0054, 0.0054, 0.0055, 0.0056, 0.0058, 0.0060, 0.0063, 0.0066, 0.0070, 0.0075,
    ];
