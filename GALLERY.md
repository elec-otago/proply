...
per-station section list), and lists the motor's maximum-efficiency
operating point — the RPM every design runs at and the torque available
there (`optimum <RPM> RPM / <torque> N m`). Props are listed below
alphabetically; diameter is twice the design radius, and V is the forward
airspeed the prop is designed for (0 = static/hover).

## LD1510_2200kv

[![LD1510_2200kv](images/LD1510_2200kv.png)](images/LD1510_2200kv.png)

2 blades, Ø 125 mm — LD1510 2200 Kv @ 7.4 V, optimum 15,062 RPM /
0.0107 N m, 2 N thrust, V = 20 m/s.
...
2 blades, Ø 228 mm — DJI Phantom 3 stock motor, 800 Kv @ 14.8 V, optimum
11,134 RPM / 0.0847 N m, 12 N thrust,
...
3 blades, Ø 127 mm — DYS 1806 2300 Kv @ 11 V, optimum 22,724 RPM /
0.022 N m, 5 N thrust, static.
...
2 blades, Ø 240 mm — DYS 2814 910 Kv @ 11 V, optimum 9,265 RPM /
0.13 N m, 8 N thrust, static.
...
3 blades, Ø 40 mm — Flywoo Robo RB1202.5 11500 Kv @ 3.7 V (1S), optimum
41,417 RPM / 0.00228 N m, 0.5 N thrust,
...
3 blades, Ø 127 mm — Multistar 1704 1900 Kv @ 11 V, optimum 18,064 RPM /
0.016 N m, 5 N thrust, static.
...
5 blades, Ø 125 mm — Multistar 2209 980 Kv @ 11 V, optimum 9,734 RPM /
0.0454 N m, 5 N thrust target,
...
5 blades, Ø 125 mm — NTM 28-26 1200 Kv @ 12 V, optimum 13,063 RPM /
0.0389 N m, 5 N thrust, V = 2 m/s.
...
2 blades, Ø 200 mm — NTM Propdrive 28-36 750 Kv @ 16.7 V, optimum
11,239 RPM / 0.122 N m, 40 N thrust,
...
2 blades, Ø 400 mm — NTM Propdrive 42-48 650 Kv @ 16.7 V, optimum
10,600 RPM / 0.244 N m, 40 N thrust,
...
modelled as 1900 Kv @ 11 V (optimum 18,064 RPM / 0.016 N m),
...
2 blades, Ø 1200 mm — paraglider motor (MP202/80 KV28), optimum
5,473 RPM / 244 N m, 30 N thrust,
...
3 blades, Ø 136 mm — Multistar 1706-class 5 in prop on 3S (1900 Kv @ 11 V,
optimum 18,064 RPM / 0.016 N m), 3 N thrust,
...
2 blades, Ø 700 mm — Turnigy CA120 150 Kv (100 cc equivalent), optimum
2,975 RPM / 14 N m, 200 N thrust,
